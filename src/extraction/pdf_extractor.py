...
import fitz  # PyMuPDF Bibliothèque principale pour manipuler les PDF
import os
import re
from pathlib import Path # Pour la gestion des chemins de fichiers
from typing import List, Dict, Optional, Tuple #Pour les annotations de type
import logging #Pour le suivi des opérations

# Configure logging ;Configure un système de journalisation pour suivre l'exécution
...
class PDFExtractor:
    ...
    #min_text_length : Évite les pages avec trop peu de texte ,max_file_size_mb : Limite la taille des fichiers traités
    ...
    #Fonctionnement : Validation du fichier PDF Ouverture du document avec PyMuPDF Parcours de chaque page et extraction du texte Nettoyage du texte extrait Fermeture du document Retour des résultats structurés
